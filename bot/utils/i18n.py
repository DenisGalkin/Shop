...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "heleket_not_configured": "Heleket не настроен",
    ...
    "en": {
        ...
        "heleket_not_configured": "Heleket is not configured",
    ...
    "uk": {
        ...
        "heleket_not_configured": "Heleket не налаштовано",
...
ERROR_TRANSLATION_KEYS = {
    ...
    "Heleket не настроен": "heleket_not_configured",
