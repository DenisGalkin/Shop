  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between px-6 py-3.5 bg-background/80 backdrop-blur-xl border-b border-border">
      <div className="flex items-center gap-2">
        <span className="text-muted-foreground text-sm">VEXND SHOP</span>
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={onLogout} className="w-8 h-8 rounded-xl bg-neon/10 border border-neon/25 flex items-center justify-center text-xs font-bold text-neon cursor-pointer hover:bg-neon/20 transition-colors" title="Log out">
